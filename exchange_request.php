<?php
    ...
    include "includes/handlers/exchange_request.php"; 
        ...
        <div class="container">
            ...
            <div class="complete-step">
                ...
                <p class="request-text">
                    <span class="bold"> <i class="fas fa-exclamation-triangle"></i>   <?php echo $row["email_1"] ;?> </span> <?php echo lang("send you a payment request to exchange money this is an amount if your are accept confirm the transfer now ."); ?>
                </p>
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ."?transferid=". $row["transfer_id"] ; ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="buttons">
                        ...
                        <button name="payment_request_btn" type="submit"> <?php echo lang("Confirm") ; ?> <i class="fas fa-check"></i></button>
